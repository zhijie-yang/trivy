				...
				PackageInfos: []types.PackageInfo{
					{
						...
						Packages: []types.Package{
							...
							},
							{
								...
								Arch:       "amd64",
								SrcName:    "libzstd1",
								SrcVersion: "1.5.5+dfsg2",
								SrcRelease: "2build1.1",
